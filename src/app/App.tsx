...
import siterhofImage from 'figma:asset/6d3baf1e9f11b0d35ff065ff2762d6f43eaa0ec3.png';
import carrieImage from 'figma:asset/745f36087ece507a0007262e4e434b5a7ab20b18.png';
import teenImage1 from 'figma:asset/959e6d2976b059b7982aa8a7898dea503c312ec4.png';
import teenImage2 from 'figma:asset/acdeac8c21a3e492d22e4678bc103a7f6bd1a083.png';
import teenImage3 from 'figma:asset/28e6ecf978ce332efa77faa849f8d44405cf6ad4.png';
import teenImage4 from 'figma:asset/99bd3955d36ab88561e0d36dbe678b24e422d120.png';
import teenImage5 from 'figma:asset/b3a8cd65eee248961357cd95e82063faaef0b0f2.png';
import heroBackground from 'figma:asset/26496142eb08b4302f1c4f974565f899b474aba9.png';
            ...
            <div className="hidden md:flex space-x-8">
              {navItems.map(item => (
                <button
                  ...
                  style={
                    activeSection === item.id
                      ? { color: '#C9968B', borderColor: '#C9968B' }
                      : {}
                  }
                  onMouseEnter={(e) => {
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  In een van de schuren op de boerderij is de workshopruimte ingericht en gaan 
                  de kinderen creatief aan de slag.
                </p>
                <p>
                  Halverwege is er een pauze. Iedereen krijgt dan van ons wat te drinken.
                </p>
                <p>
                  Er kan zelf iets lekkers meegenomen worden. Bij mooi weer kunnen de kinderen 
                  in de tuin spelen.
                </p>
                ...
                <p className="font-semibold" style={{ color: '#C9968B' }}>
                  ...
                  contactformulier en ik stuur je foto's van de workshops waaruit gekozen kan worden!
                </p>
              </div>
            </div>
      ...
      <section id="kinderworkshops" className="py-20" style={{ backgroundColor: '#F4EFE9' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            <div className="space-y-4 text-gray-700">
              <p>
                Zomer of winter, lente of herfst. De Siterhof puilt uit van ideeën om iets bijzonders 
                te maken. Iedere maand is er een thema-workshop.
              </p>
              <p>
                Ons doel is dat iedereen zo veel mogelijk plezier aan de workshop beleefd en met een 
                trots en tevreden gevoel naar huis gaat. In de pauze krijgen de kinderen wat lekkers.
              </p>
              <p>
                Naast kinderfeestjes geven we ook nog themaworkshops voor de kinderen. Via mail sturen 
                we een beschrijving met foto van de themaworkshops (Pasen, Moederdag, Sinterklaas en Kerst). 
                Wil je hiervan op de hoogte blijven meld je dan aan in ons mailbestand.
              </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr style={{ backgroundColor: '#F4EFE9' }}>
                    <th className="border px-4 py-3 text-left font-semibold text-gray-900" style={{ borderColor: '#C9968B' }}>Maand</th>
                    <th className="border px-4 py-3 text-left font-semibold text-gray-900" style={{ borderColor: '#C9968B' }}>Thema</th>
                    <th className="border px-4 py-3 text-left font-semibold text-gray-900" style={{ borderColor: '#C9968B' }}>Data</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-200 px-4 py-3 font-semibold" style={{ color: '#C9968B' }}>Pasen</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-200 px-4 py-3 font-semibold" style={{ color: '#C9968B' }}>Moederdag</td>
                  ...
                  <tr style={{ backgroundColor: '#F4EFE9' }}>
                    <td className="border px-4 py-3 font-semibold text-gray-900" colSpan={3} style={{ borderColor: '#C9968B' }}>
                      In de zomervakantie (13 juli tot 24 augustus) is er elke woensdagmiddag een speciaal 
                      programma voor kinderen. Het programma bestaat uit een workshop, picknick en spelletjes spelen. 
                      Ook kunnen er in juli en augustus kinderfeestjes gevierd worden.
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="border border-gray-200 px-4 py-3 font-semibold" style={{ color: '#C9968B' }}>Sinterklaas</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-200 px-4 py-3 font-semibold" style={{ color: '#C9968B' }}>Kerst</td>
            ...
            <div className="space-y-4 text-center text-gray-700">
              <p>
                De kinderworkshops op <strong>woensdag</strong> zijn van <strong>14:00 tot 16:00 uur</strong>. 
                Op <strong>vrijdag</strong> kunnen de kinderen genieten van een workshop van <strong>15:00 tot 17:00 uur</strong>.
              </p>
              ...
              <p className="text-sm">
                Zoals altijd wordt er nog een aparte mail met foto gestuurd. Wil je dit ook ontvangen, 
                stuur ons even je mailadres naar <a href="mailto:info@siterhof.com" className="hover:underline" style={{ color: '#C9968B' }}>info@siterhof.com</a>
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-gray-700 mb-4">
                  In de zomervakantie hebben we elke woensdagmiddag een speciaal programma voor kinderen. 
                  De kinderen kunnen dan bij ons terecht voor een gezellige middag.
                </p>
                <div className="space-y-3 text-gray-700">
                  <p className="font-semibold" style={{ color: '#C9968B' }}>Aanvang: 12:30 uur</p>
                  <p>We beginnen met een gezellige picknick in de tuin!</p>
                  <p>
                    Daarna starten we met de workshop. In de pauze genieten we van iets lekkers 
                    en iets fris te drinken en spelen we in de tuin en zijn er allerlei spelletjes te spelen.
                  </p>
                  <p className="font-semibold" style={{ color: '#C9968B' }}>Einde: 16:30 uur</p>
                  <p>
                    De kinderen kunnen kiezen uit verschillende workshops, vraag naar de mogelijkheden.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    In het landelijke, heuvelachtige gebied ten zuiden van Sittard vindt u de Siterhof. 
                    Een sfeervolle locatie in de voormalige schuren van een oude carréboerderij net over 
                    de Duitse grens in het kleine dorpje Hillensberg, waar een grote verscheidenheid aan 
                    creatieve workshops wordt gegeven.
                  </p>
                  <p>
                    Ook organiseren wij creatieve workshops voor kinderen en kinderfeestjes. Bij alle 
                    creatieve workshops ligt de nadruk op het werken met natuurlijke materialen.
                  </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="text-gray-600 space-y-2 leading-relaxed">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <p className="text-sm font-medium" style={{ color: '#C9968B' }}>Net over de Duitse grens</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="p-8 rounded-lg shadow-lg text-center" style={{ backgroundColor: '#F4EFE9' }}>
              ...
              <p className="mt-6 text-gray-700">
                Volg De Siterhof natuurlijk ook op Facebook
              </p>
            </div>
          </div>
        </div>
